<template>
  <div class="w-full">
    ...
    <section class="bg-partner relative max-w-full sm:mx-6 my-24 shadow sm:rounded-2xl overflow-hidden">
      <div class=" px-6 sm:px-0 py-16 flex flex-col items-center justify-center space-y-4 text-center">
    ...
    <section class="w-full my-36">
      <BaseSection data-aos="fade-down">
        <div class="col-span-12 lg:col-span-7">
          <div class="w-full">
            <img :src="require('~/assets/img/DenoTrade-cc.webp')" class="w-[95%]" alt="" />
          </div>
        </div>
        <div class="col-span-12 lg:col-span-5 space-y-6 px-4 sm:px-6 mt-20">
          <h2 class="text-4xl font-semibold">
            Introducing the <span class="text-header-gradient">DenoTrade</span> Credit Card
          </h2>
          ...
          <ul class="space-y-4 sm:space-y-2">
            ...
            <LandingListItem title="Earn rewards in bitcoin or any crypto on DenoTrade" />
          ...
          <ul class="space-y-8 sm:space-y-4">
            <LandingListItem title="Safety, security and compliance">
              <p class="text-sm text-gray-700 leading-relaxed">
                DenoTrade is a licensed New York trust company that undergoes regular bank exams and is subject to the
            ...
            <LandingListItem title="Hardware security keys">
              <p class="text-sm text-gray-700 leading-relaxed">
                With DenoTrade you can secure your account with a hardware security key via WebAuthn.
              </p>
            </LandingListItem>
            <LandingListItem title="SOC Certifications">
              <p class="text-sm text-gray-700 leading-relaxed">
                DenoTrade is <span class="underline">SOC 1 Type 2</span> and
...
export default {
  ...
  data() {
    return {
      ...
      accordions: [
        {
          title: 'Why should I choose DenoTrade?',
          description:
      ...
      steps: [
        {
          ...
          title: 'Sign Up',
          description:
            'Sign up for your free DenoTrade Wallet on web, iOS or Android and follow our easy process to set up your profile',
        },
        {
          img: 'fund.png',
          title: 'Fund',
          description:
            'Choose your preferred payment method such as bank transfer or credit card to top up your DenoTrade Wallet',
        },
        {
          img: 'buy-crypto.png',
          title: 'Buy Crypto',
